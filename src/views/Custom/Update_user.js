...
export default function Update_user() {
  ...
  function onClick(e){
    console.log(e);
axios.get(`http://localhost:5000/account_update?
account_pw=${account_pw}&account_name=${account_name}&phone=${phone}&sex=${sex}&birth_date=${birth_date}&address=${address}&job=${job}&permission=${permission}&account_id=${account_id}
        ...
        <GridContainer>
          ...
          <GridItem xs={12} sm={12} md={8}>
            <Card>
              ...
              <CardFooter>
                <Button onClick={e=>onClick(e)} color="primary">update</Button>
              </CardFooter>
            </Card>
          </GridItem>
        </GridContainer>
