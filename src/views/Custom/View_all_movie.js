...
export default function View_all_movie() {
  ...
  useEffect(() => {
    console.log("fetched");
      axios.get(`http://localhost:5000/view_all_movie?`)//,{"Access-Control-Allow-Origin": "*", "headers":{'Content-Type': 'application/json'}})
      ...
      <GridItem xs={12} sm={12} md={5}>
        ...
        <GridItem xs={12} sm={12} md={8}>
          ...
          <CardHeader color="primary">
            <h4 className={classes.cardTitleWhite}>View all movie</h4>
            <p className={classes.cardCategoryWhite}>movies</p>
          </CardHeader>
